...
public class Xception extends TException implements org.apache.thrift.TBase<Xception, Xception._Fields>, java.io.Serializable, Cloneable, Comparable<Xception> {
  ...
  static {
    ...
    schemes.put(TupleScheme.class, new XceptionTupleSchemeFactory());
  }
  ...
  private static class XceptionTupleSchemeFactory implements SchemeFactory {
    public XceptionTupleScheme getScheme() {
      return new XceptionTupleScheme();
    }
  }

  private static class XceptionTupleScheme extends TupleScheme<Xception> {
